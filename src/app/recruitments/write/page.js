                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                            <div style={{ overflow: 'hidden' }}>
                                ...
                                <input
                                    ...
                                    style={{ ...inputStyle(!!eventDate), padding: '11px 6px', fontSize: 13, minWidth: 0, width: '100%' }}
                                />
                            </div>
                            <div style={{ overflow: 'hidden' }}>
                                <div style={{ fontSize: 12, fontWeight: 600, color: T.gray, marginBottom: 6, display: 'flex', alignItems: 'center', gap: 4 }}>
                                ...
                                <input
                                    ...
                                    min={eventDate}
                                    style={{ ...inputStyle(!!eventDateEnd), padding: '11px 6px', fontSize: 13, minWidth: 0, width: '100%' }}
                                />
                            </div>
                        </div>
                        <div>
